  ...
  render () {
    return (
      <View style={styles.container}>
        ...
        <List  style={{height:65,position:"relative"}} >
      <Image source={require('../../iconImages/name.png')} style={{width:35, height: 35,position:"absolute",top:13,left:15}} />
        
        <Item multipleLine   extra=" " style={{marginLeft:60}}>
          检查名称<Brief style={{fontSize:20,marginTop:2}}>{this.state.name}</Brief>
        </Item>
      </List>
      <List  style={{height:65,position:"relative"}} >
      <Image source={require('../../iconImages/org.png')} style={{width:35, height: 35,position:"absolute",top:13,left:15}} />
        
        <Item multipleLine   extra=" " style={{marginLeft:60}}>
          检查单位<Brief style={{fontSize:20,marginTop:2}}>{this.state.org}</Brief>
        </Item>
      </List>
      <List  style={{height:65,position:"relative"}} >
      <Image source={require('../../iconImages/person.png')} style={{width:35, height: 35,position:"absolute",top:13,left:15}} />
        <Item multipleLine extra=" "   style={{marginLeft:60}}>
          检查人 <Brief style={{fontSize:20,marginTop:2 }}>{this.state.inspectorName}</Brief>
        </Item>
      </List>
      <List  style={{height:65,position:"relative"}} >
      <Image source={require('../../iconImages/time.png')} style={{width:35, height: 35,position:"absolute",top:13,left:15}} />
      
        <Item multipleLine extra=" " style={{marginLeft:60}}>
          检查时间 <Brief style={{fontSize:20,marginTop:2}}>{this.state.time}</Brief>
        </Item>
      </List>
      <WhiteSpace size="sm" />
      <Flex>
